...
def main():
    ...
    # 1. 加载模型和分词器
    tokenizer = AutoTokenizer.from_pretrained("./qwen-merged-model", trust_remote_code=True)
    model = AutoModelForCausalLM.from_pretrained("./qwen-merged-model", torch_dtype=torch.bfloat16, device_map="auto")
    ...
    training_args = TrainingArguments(
        ...
        learning_rate=1.2e-7,              # 学习率，LoRA通常比全参数微调高一些
